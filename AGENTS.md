...
- Design: mid-2000s retro (XP-beige panels, navy title bars, beveled `.bevel-out`/`.bevel-in` edges, Space Needle SVG motifs, system fonts only). Tokens live in `app/globals.css` — use those, not ad-hoc colors. Build pages out of `RetroPanel`.
